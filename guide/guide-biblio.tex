...
Il existe aussi le test \ci{if ... elif ... elif ... else ...} qui permet d'enchaîner les tests et qui n'est pas abordé ici. 
...
Un bon informaticien devrait vérifier que le paramètre passé en argument vérifie bien l'hypothèse attendue. Par exemple si \ci{fonc(x)} est définie pour un entier \ci{x} et que l'utilisateur transmet un chaînes de caractères, alors un gentil message d'avertissement devrait être envoyé à l'utilisateur sans faire échouer tout le programme !
