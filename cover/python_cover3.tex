...
\begin{document}%
  \begin{tikzpicture}
    ...
    \begin{scope}[transform canvas ={yshift=21mm}]
      ...
      \path (Cover.east) +(60mm,-105mm) node[left,scale=2.5,text width=.35\PageW,align=left,fill=white,text=subtitlealgo,inner sep=.7em,font=\authorfont]{\bf Algorithmes et programmation\vphantom{\Large t}};
    \end{scope}
    % ---------------------------------------------------
    % Spine
    % ---------------------------------------------------
