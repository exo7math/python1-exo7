...
\objectifs{Les listes sont tellement utiles qu'il faut savoir les manipuler de façon simples et efficaces. C'est le but de cette fiche !}
...
\begin{itemize}
   ...
   \ci{liste.index(element)} et renvoie la première position à laquelle l'élément a été trouvé. Exemple : avec \ci{liste = [12, 30, 5, 9, 5, 21]},
...
\end{itemize}
  ...
  \begin{itemize}
  \item \ci{tableau[0]} renvoie la sous-liste \ci{[2,14,5]},
  \item \ci{tableau[1]} renvoie la sous-liste \ci{[3,5,7]},
...
\begin{enumerate}
 ...
 \medskip
  ...
  \emph{Le but des questions restantes est de créer des carrés magiques de grandes tailles.}
