...
def diagramme_boite(effectifs_notes):
    """ Boîte à moustaches """

    # Graphique en barres
    for i in range(len(effectifs_notes)):  # i varie de 0 à 20
        hauteur = effectifs_notes[i] * echelle
    ...
    max_effectifs = max(effectifs_notes)
...
diagramme_boite(effectifs_notes)
root.mainloop()