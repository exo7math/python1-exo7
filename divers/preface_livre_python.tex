...
\descriptionactivite{Les listes sont tellement utiles qu'il faut savoir les manipuler de façon simples et efficaces. C'est le but de cette fiche !}
...
\descriptionactivite{Le \emph{bitcoin} est une monnaie dématérialisée et décentralisée. Elle repose sur deux principes informatiques : la cryptographique à clé publique et la preuve de travail. Pour comprendre ce second principe, tu vas créer un modèle simple de \emph{bitcoin}.}
