...
\insertvideo{kLdHGVD2qZo}{Fichiers - partie 1 - Écrire un fichier}

\insertvideo{e3OWL8e4yZQ}{Fichiers - partie 2 - Lire un fichier}

\insertvideo{Uw2yKTEqOmI}{Fichiers - partie 3 - Images}
...
\end{center} 
  ...
  \begin{center}
\includegraphics[scale=\myscale,scale=0.5]{ecran-fichiers-2c}
\end{center}  
